 ...
 *
 * Program reads an ASCII text file of a text written in english, which may contain
 * misspellings. The program corrects any misspellings by printing the same text,
 * with corrected words, replacing those which were previously misspelled.
 *
 */
public class LEAssignment4Ver2 {
